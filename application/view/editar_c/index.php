...
<body>
    ...
    <div class="wrapper">
        <div id="formContent">
            ...
            <!-- Login Form -->
            <form method="POST" action="<?php echo URL; ?>recuperar_c/updatePasswordWithCode">
                <input type="hidden" id="txtIdUsuario" name="txtIdUsuario" placeholder="Código del Usuario" value="<?php echo $usuario->idUsuario; ?>">
            ...
            <!-- Remind Passowrd -->
            <div id="formFooter">
                <a class="underlineHover" href="<?php echo URL; ?>perfil">Volver a perfil</a>
            </div>
