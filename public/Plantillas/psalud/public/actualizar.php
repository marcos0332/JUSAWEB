	...
	<div class="container-fluid">
		<div class="container-fluid">
			<div class="row">
				...
				<div class="col-md-5">
					<h2>Actualización de paciente</h2>
			
					<br>
					<form action="Actualizar1.php" method="post">
						<div class="form-group">
							<label for="exampleInputPassword1">Documeto de identidad</label>
							<input type="text" name="id" class="form-control" id="exampleInputPassword1" placeholder="Ingrese el documento de identidad" >
						</div>
						
						
<br>	
					<input type="submit" name="buscar"  class="btn btn-outline-success"></input>
				...
				<div class="col-md-5">
					...
					<h2>Eliminar un paciente</h2>
			
					<br>
					<form action="del.php" method="post">
						<div class="form-group">
							<label for="exampleInputPassword1">Documeto de identidad</label>
							<input type="text" name="id"name="id" class="form-control" id="exampleInputPassword1" placeholder="Ingrese el documento de identidad" >
						</div>
