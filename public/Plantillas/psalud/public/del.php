...
$registros=mysqli_query($conexion, "select id from pacientes
                        where id='$_REQUEST[id]'") or
  die("Problemas en el select:".mysqli_error($conexion));
if ($reg=mysqli_fetch_array($registros))
{
  mysqli_query($conexion,"delete from pacientes where id='$_REQUEST[id]'") or
    die("Problemas en el select:".mysqli_error($conexion));
  echo "Se efectuó el borrado del alumno con dicho documento de identidad.";
}
else
{
  echo "No existe un paciente con esa cedula.";
}
