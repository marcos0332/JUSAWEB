...
mysqli_query($conexion,"insert into servicios(empresa,nservicio,ids,infos) values 
                       ('$_REQUEST[empresa]','$_REQUEST[nservicio]',$_REQUEST[ids],'$_REQUEST[infos]')")
  or die("el id ya existe  ".mysqli_error($conexion));

mysqli_close($conexion);

echo "<CENTER><h1>El servicio fue registrado.</h1> </CENTER>";
?>
