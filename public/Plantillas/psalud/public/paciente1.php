...
mysqli_query($conexion,"insert into Pacientes(nombre,id,info,empresa) values 
                       ('$_REQUEST[nombre]',$_REQUEST[id],'$_REQUEST[info]','$_REQUEST[empresa]')")
  or die("el documento de identidad ya existe  ".mysqli_error($conexion));

mysqli_close($conexion);

echo "<CENTER><h1>El Paciente fue registrado.</h1> </CENTER>";
?>
